...
import com.zcbspay.platform.instead.utils.validator.Ans;

/**
 * 【ANS】字母字符 或 数字字符 或 特殊字符
 *
 * @author yangpeng
 * @version
...
public class AnsImpl implements ConstraintValidator<Ans, String> {
	private int max;
	private int min;
	 ...
	 */
	@Override
	public void initialize(Ans arg0) {
		this.max = arg0.max();
		this.min = arg0.min();
